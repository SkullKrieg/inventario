...
<div class="bitacora-form">
    ...
    <?= $form->field($model, 'HTTP_HOST')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'SERVER_PORT')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'REMOTE_ADDR')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'REMOTE_PORT')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'SERVER_PROTOCOL')->textInput(['maxlength' => true]) ?>
